...
export const projectsInfo = [

    {
      ...
      'tools': 'C#, Python, Unity, OpenAI: Whisper and GPT-4.0, Reinforcement Learning: DQN and Q-Learning, Dialogflow, GCP, AWS Lambda, Amazon Gateway, AWS EC2, Amazon Polly',
      ...
      'youtube': '',
      'code' : 'https://github.com/Anirudh2k0/PedagogicalAgent',
    },
    {
      'id': 2,
      'title': 'RISE',
      ...
      'tools': 'Python, React, Node.js, Pytorch, Reinforcement Learning: MADDPG, React, AWS EC2, Amazon S3, Cloudlets',
      ...
      'code': 'https://github.com/melemus/rise_environment',
    },
    {
      'id':3,
      'title': 'WFMZ-TV',
      ...
      'tools': 'Python, React, Flask, Docker,AWS EC2, AWS DynamoDB, Amazon S3',
      ...
      'youtube': '',
      'code': 'https://github.com/hemanth5555/wfmz-tv-production',
    },
    {
      'id': 4,
      'title': 'BODIGUIDE',
      ...
      'tools': 'Python, React, Amazon VPC, AWS IAM, SG, AWS KMS, AWS Lambda, AWS RDBMS, Amazon S3, Amazon API Gateway, AWS EC2',
